//Calculates ratios for truncated parts of the distribution using data from 2004,2006,2012,and 2014
...
replace consumption = consumption/(82.9535/100) if year == 2004
replace income = income/(86.36923/100) if year == 2006
replace consumption = consumption/(86.36923/100) if year == 2006
replace income = income/(98.48837/100) if year == 2012
replace consumption = consumption/(98.48837/100) if year == 2012
...
replace weight = weight/curr_total_weight if year == 2004
drop curr_total_weight
egen curr_total_weight = sum(weight) if year == 2006
replace weight = weight/curr_total_weight if year == 2006
drop curr_total_weight
egen curr_total_weight = sum(weight) if year == 2012
replace weight = weight/curr_total_weight if year == 2012
drop curr_total_weight
egen curr_total_weight = sum(weight) if year == 2014
replace weight = weight/curr_total_weight if year == 2014
drop curr_total_weight
...
esttab matrix(final_table) using table3.txt, replace
